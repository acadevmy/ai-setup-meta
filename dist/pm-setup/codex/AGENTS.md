...
|---|---|
| `pm-flow [PATH_DOCUMENTO]` | Flusso completo: dal documento ai task su ClickUp |
| `pm-intake [PATH_DOCUMENTO]` | Parsing di un documento → Discovery Brief |
...
| `pm-refine` | Valida qualita' INVEST e arricchisce Acceptance Criteria |
| `pm-review` | Revisione e approvazione con il PM |
| `pm-publish` | Pubblica i task approvati su ClickUp |

> Usa `pm-flow` per il flusso completo guidato.
