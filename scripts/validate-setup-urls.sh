...
REQUIRED_FILES=(
  ...
  "templates/dev-setup-template/.claude/skills/start-task/SKILL.md"
  "templates/dev-setup-template/.claude/skills/tdd/SKILL.md"
  "templates/dev-setup-template/.claude/skills/review/SKILL.md"
  "templates/dev-setup-template/.claude/skills/sync-task/SKILL.md"
