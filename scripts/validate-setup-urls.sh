...
REQUIRED_FILES=(
  ...
  "templates/dev-setup-template/.claude/skills/start-task.md"
  "templates/dev-setup-template/.claude/skills/tdd.md"
  "templates/dev-setup-template/.claude/skills/review.md"
  "templates/dev-setup-template/.claude/skills/sync-task.md"
